/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a9a3b5a35aa022a3d6b4bbd872446083)
// Runtime types generated with workerd@1.20260421.1 2024-09-23 nodejs_compat_v2
declare namespace Cloudflare {
	interface StagingEnv {
		...
		R2_BUCKET_NAME: "symeno-images-staging";
	...
	interface Env {
		...
		DB: D1Database;
		R2_ACCOUNT_ID: "your_cloudflare_account_id";
		R2_BUCKET_NAME: "symeno-images-staging" | "symeno-images";
		PUBLIC_SITE_URL: string;
		PUBLIC_STRIPE_KEY: string;
		STRIPE_SECRET_KEY: string;
		STRIPE_WEBHOOK_SECRET: string;
